...
$MM_restrictGoTo = "index_almacen3.php";
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <div class="mini-stat-info">
                                            <span class="counter text-purple"><?php echo $totalRows_almacen2 ?></span>
                                            Productos disponibles
                                        </div>
                                        <div class="clearfix"></div>
                                        <p class=" mb-0 m-t-20 text-muted">Productos Totales: <?php echo $totalRows_almacen2 ?><span class="pull-right"> <!--<i class="fa fa-caret-up m-r-5"></i>10.25%</span>--></p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
