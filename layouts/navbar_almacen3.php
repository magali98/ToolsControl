...
<div class="topbar-left">
    <div class="">
        ...
        <a href="index_almacen3.php" class="logo"><img src="public/assets/images/logo-sm.png" height="36" alt="logo"></a>
    </div>
</div>
...
<div class="sidebar-inner slimscrollleft">
    <div id="sidebar-menu">
        <ul>
            ...
            <li>
                <a href="index_almacen3.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Dashboard <span class="badge badge-pill badge-primary pull-right">0</span></span> </a>
            ...
            <li class="menu-title">Materiales</li>

            <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cube-outline"></i><span> Materiales </span></a>
                    <ul class="list-unstyled">
                        <li><a href="consultar_productos3.php">Consultar</a></li>
                        <li><a href="agregar_producto_almacen3.php">Agregar</a></li>
    ...
    <!--    <li class="has_sub">
            ...
            <li>
                <a href="solicitud_admin3.php" class="waves-effect"><i class="mdi mdi-calendar-check"></i><span> Solicitudes </span></a>
            </li>
...
-->
            <li>
                <a href="#" class="waves-effect"><i class="mdi mdi-file-document-box"></i><span> Instrucciones de uso </span></a>
            </li>
