...
<div class="topbar-left">
    <div class="">
        ...
        <a href="index_user.php" class="logo"><img src="public/assets/images/logo-sm.png" height="36" alt="logo"></a>
    </div>
</div>
...
<div class="sidebar-inner slimscrollleft">
    <div id="sidebar-menu">
        <ul>
            ...
            <li>
                <a href="index_user.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Dashboard <span class="badge badge-pill badge-primary pull-right">0</span></span> </a>
            ...
            <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-calendar-check"></i><span> Solicitudes </span></a>
                    <ul class="list-unstyled">
                        <li><a href="solicitar_insumo.php">Solicitar</a></li>
...
<!--
            <li>
                <a href="index.php" class="waves-effect"><i class="mdi mdi-calendar-check"></i><span> Solicitudes </span></a>
            </li>
-->
...
<!--
            ...
            <li>
                <a href="contact.php" class="waves-effect"><i class="mdi mdi-headset"></i><span> Contact <span class="badge badge-pill badge-warning pull-right">3</span> </span></a>
            </li>
-->
            <li>
                <a href="index_user.php" class="waves-effect"><i class="mdi mdi-file-document-box"></i><span> Instrucciones de uso </span></a>
            </li>
