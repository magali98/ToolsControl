...
<body class="fixed-left">
        ...
        <?php include 'layouts/navbar_user.php'; ?>
                         ...
                         <!--   <div class="row">
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <div class="mini-stat-info">
                                            <span class="counter text-purple">240</span>
                                            Productos disponibles
                                        </div>
                                        <div class="clearfix"></div>
                                        <p class=" mb-0 m-t-20 text-muted">Productos Totales: 318 <span class="pull-right"> --><!--<i class="fa fa-caret-up m-r-5"></i>10.25%</span>--> <!-- </p>
                                    </div>
                                </div> 
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                ...
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <div class="mini-stat-info">
                                            <span class="counter text-brown">2</span>
                                            Usuarios Activos
                                        </div>
                                        <div class="clearfix"></div>
                                        <p class="text-muted mb-0 m-t-20">Total de usuarios: 16 <span class="pull-right"></p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-3">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <div class="mini-stat-info">
                                            <span class="counter text-teal">48 Hrs.</span>
                                            Uso continuo
                                        </div>
                                        <div class="clearfix"></div>
                                        <p class="text-muted mb-0 m-t-20">Mantenimiento en: 240 Hrs <span class="pull-right"></p>
                                    </div>
                                </div>
                            </div>   
-->
...
<!--
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <h4 class="mt-0 m-b-30 header-title">Ultima Solicitud</h4>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-vertical mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button type="button" class="btn btn-secondary btn-sm waves-effect">Entregar</button></td>
                                                        <td>
                                                         <!--   24
                                                        ...
                                                        <td>
                                                         <!--   <button type="button" class="btn btn-secondary btn-sm waves-effect">Recibisr</button>  -->
                                                        </td>
                                                    </tr>
