...
<?php include 'layouts/headerStyle.php'; ?>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="home-wrapper m-t-40">
                            ...
                            <h3 class="m-t-30">Instrucciones de uso</h3>
                            <p>Por el momento nos encontramos trabajando en esta sección ¡Vuelve mas tarde! </p>
    ...
    <script type="text/javascript">
        $(".count-down").ccountdown(2020,08,11,'12:00');
    </script>
